...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="public/css/ActividadesAtractivos.css">
                    ...
                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content" style="color: white">
                                ...
                                <div class="form-field col-lg-12 " style="margin-top: 10px" id="precio">
                                ...
                                <div class="form-field col-lg-6 " id="imagen1">
                                    <img src="public/css/img/atractivo1.jpg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 " id="imagen2">
                                    <img src="public/css/img/atractivo2.jpg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 modalVideo" id="video">
                                    <iframe width="400" height="300" src="https://www.youtube.com/embed/wvACn9Ysghk"
                                ...
                                <div class="form-field col-lg-6 modalMapa" id="mapa">
                        ...
                        <div class="modal fade bd-example-modal-2g" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="color: white">
                                    ...
                                    <div class="form-field col-lg-6 " id="imagen1">
                                        <img src="public/css/img/volcanPoas.jpg" width="400" height="341">
                                    </div>

                                    <div class="form-field col-lg-6 " id="imagen2">
                                        <img src="public/css/img/volvanPoas2.jpg" width="400" height="341">
                                    </div>

                                    <div class="form-field col-lg-6 modalVideo" id="video">
                                        <iframe width="400" height="300" src="https://www.youtube.com/embed/Q3LowuntKm8"
                                                title="YouTube video player" frameborder="0"
                                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                allowfullscreen>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="color: white">
                                   ...
                                   Entre las criaturas marinas que se pueden observar están los elefantes marinos, delfines, ballenas jorobadas, arrecifes de coral, reptiles y un gran número de otras criaturas, así como muchas especies de aves. Estas incluyen fragatas, ibis o pelícanos. La mayoría de ellos anidan en la costa de Isla Ballena. A diferencia del área terrestre, la superficie del agua del Parque Nacional Marino Ballena cubre casi 5,400 hectáreas.
                                    ...
                                    <div class="form-field col-lg-6 " id="imagen1">
                                        <img src="public/css/img/marioBallena.jpg" width="400" height="341">
                                    </div>

                                    <div class="form-field col-lg-6 " id="imagen2">
                                        <img src="public/css/img/marinoBallena2.jpg" width="400" height="341">
                                    </div>

                                    <div class="form-field col-lg-6 modalVideo" id="video">
                                        <iframe width="400" height="300" src="https://www.youtube.com/embed/wf_mL-S5TXc"
                                                title="YouTube video player" frameborder="0"
                                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                allowfullscreen>
                    ...
                    <div class="modal fade bd-example-modal-4g" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content" style="color: white">
                                ...
                                <div class="form-field col-lg-6 " id="imagen1">
                                    <img src="public/css/img/canopy2.jpg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 " id="imagen2">
                                    <img src="public/css/img/canopy.jpg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 modalVideo" id="video">
                                    <iframe width="400" height="300" src="https://www.youtube.com/embed/f45Vh8r4Whk"
                                            title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen>
                    ...
                    <div class="modal fade bd-example-modal-5g" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content" style="color: white">
                                ...
                                <div class="form-field col-lg-6 " id="imagen1">
                                    <img src="public/css/img/surfear.jpg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 " id="imagen2">
                                    <img src="public/css/img/surfing2.jpeg" width="400" height="341">
                                </div>

                                <div class="form-field col-lg-6 modalVideo" id="video">
                                    <iframe width="400" height="300" src="https://www.youtube.com/embed/R7ExAwN68Ac"
                                            title="YouTube video player" frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen>
