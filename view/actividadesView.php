                ...
                if($( ".select-atractivos" ).val() === "1"){
                    ...
                    if($( ".select-atractivos" ).val() === "2"){
                        $(".contenedor-atractivos").html('<div style="grid-column-start: 1; grid-column-end: 1;" class="">\n' +
                            ...
                            '\n' +
                            '                            <div class="form-field col-lg-6 " id="imagen1">\n' +
                            '                                <img src="public/css/img/rafting.jpg" width="400" height="341">\n' +
                            '                            </div>\n' +
                            '\n' +
                            '                            <div class="form-field col-lg-6 " id="imagen2">\n' +
                            '                                <img src="public/css/img/rafting2.jpg" width="400" height="341">\n' +
                            '                            </div>\n' +
                            '\n' +
                            '                            <div class="form-field col-lg-6 modalVideo" id="video">\n' +
                            '                                <iframe width="400" height="300" src="https://www.youtube.com/embed/T-ys08EXFt8"\n' +
                            '                                        title="YouTube video player" frameborder="0"\n' +
                            '                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"\n' +
                            '                                        allowfullscreen>\n' +
                            '\n' +
...
<div class="row contenedor-atractivos">
        ...
        <div style="grid-column-start: 1; grid-column-end: 1;" class="">
            <div>
                <h3 class="text-center">Canopy</h3>
                <div class="img-actividad">
                    <img type="button" src="public/css/img/canopy.jpg" width="400" height="341" data-toggle="modal" data-target=".bd-example-modal-lg">
                </div>
            </div>
            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
        ...
        <div  style="grid-column-start: 2; grid-column-end: 2;" class="" >
            <div>
                <h3 class="text-center">Surfing</h3>
                <div class="img-actividad">
                    <img type="button" src="public/css/img/surfear.jpg" width="400" height="341" data-toggle="modal" data-target=".bd-example-modal-2g">
                </div>
            </div>
            <div class="modal fade bd-example-modal-2g" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
        ...
        <div  style="grid-column-start: 3; grid-column-end: 3;" class="">
            <div>
                <h3 class="text-center">Rafting</h3>
                <div class="img-actividad">
                    <img type="button" src="public/css/img/rafting.jpg" width="400" height="341" data-toggle="modal" data-target=".bd-example-modal-3g">
                </div>
            </div>
            <div class="modal fade bd-example-modal-3g" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
